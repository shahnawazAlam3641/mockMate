...
const ScoreCard = ({ totalScore }: { totalScore: number }) => {
  ...
  return (
    <motion.div
      ...
      className=" border border-gray-200 dark:border-gray-700 rounded-lg shadow-md p-6 text-center h-full flex flex-col justify-center"
    >
      <h3 className="text-xl font-semibold  mb-6">Overall Performance</h3>
